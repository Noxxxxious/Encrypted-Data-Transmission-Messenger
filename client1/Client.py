...
class Client:
    ...
    def connect(self):
        ...
        self.session_key = base64.b64encode(secrets.token_bytes(16))
        encrypted_session_key = rsa_encode(self.session_key.decode(), self.peer_public_key)
        self.send_message(Message(encrypted_session_key, "session-key"))
